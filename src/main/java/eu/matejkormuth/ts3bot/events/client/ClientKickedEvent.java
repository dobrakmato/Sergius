 ...
 * 
 */
public class ClientKickedEvent extends ClientLeaveChannelEvent {
    
    public ClientKickedEvent(@Nonnull final IVirtualServer server,
            @Nonnull final IClient client, @Nonnull final LeaveReason lr) {
        super(server, client, lr);
    }
}
